...
$conn->exec("DELETE FROM `tbl_pe_stats` WHERE (`user_id`='1234'); ");
...
foreach ($period as $dt) {
	...
	$query = "SELECT SUM(total_cost) AS value_sum FROM `tbl_pe_stats` WHERE status_name LIKE 'Cancelled%' AND date_from LIKE '".$thedate."%' ;";
	...
	$query = "SELECT SUM(total_cost) AS value_sum FROM `tbl_pe_stats` WHERE status_name LIKE 'Quotation%' AND date_from LIKE '".$thedate."%' ;";
