...
<?php require_once('client/_ad_header.php'); ?>
<main>
		...
		<div class="login-panel">
			<div class="login-panel__upper">
				...
				<form action="authenticate.php" method="post" name="login" id="login">
                    <?php if($e==1){?>
                        <img src="images/incorrect.jpg" width="400" height="207" alt=""/>
                    <?php }?>
...
<!-- Footer -->
<?php require_once('client/_footer.php'); ?>
<!-- End of Footer -->

<?php require_once('client/modals/logout.php'); ?>
<?php require_once('client/_global-scripts.php'); ?>
