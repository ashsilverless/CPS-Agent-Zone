...
<div class="avail-property">
	<div class="avail-property__head">
		...
		<div class="action">
			<a href="" class="button"><i class="fas fa-sign-in-alt"></i> View Property</a>
		</div>
				...
				$conn->exec("SET CHARACTER SET $charset");      // Sets encoding UTF-8
				  ...
				  while($row = $result->fetch(PDO::FETCH_ASSOC)) {
					...
					$maxdays < 50 ? $displayInfo = "<div class='avail-data ".$class."'><span>".$row['availability']."</span><span>".$row['currency'].$row['agent_rate']."</span></div>" : $displayInfo = "<div class='avail-data high ".$class."'><span>".$row['availability']."</span></div>";
					  ...
					  echo ("<td align='center' title='".$roomdate['room_title']."' data-toggle='popover' data-trigger='hover' data-html='true' data-content='Spaces available : ".$row['availability']."<br>Rate : ".$row['currency'].$row['agent_rate']."'>".$displayInfo."</td>");
