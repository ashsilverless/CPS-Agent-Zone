...
$linkqry = "&country_id=".$cntry."&region_id=".$rgion."&traveller_id=".$trav."&experience_id=".$exp."&dest_id=".$dest_id;
...
//if (isset($_GET['country_id'])){
	try {
	  ...
	  $count_sql = "SELECT prop.* ".$exp_sql1.$trav_sql1." FROM tbl_properties prop ".$exp_sql2.$trav_sql2." WHERE prop.bl_live = 1 ".$exp_sql3.$trav_sql3.$dest_sql.";";
	...
	$prop_sql = "SELECT prop.* ".$exp_sql1.$trav_sql1." FROM tbl_properties prop ".$exp_sql2.$trav_sql2." WHERE prop.bl_live = 1 ".$exp_sql3.$trav_sql3.$dest_sql." LIMIT $offset,$recordsPerPage;";
...
<?php require_once('_header.php'); ?>
    <!-- Begin Page Content -->
<main>
	<form action="properties2.php" method="get" name="property_search" id="property_search">
	...
	<div class="container">
		...
		<p class="introduction mb0"><?=$intro_text;?> <?=$pagequery;?></p>
	</div>
