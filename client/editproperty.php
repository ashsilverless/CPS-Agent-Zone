...
$rr_id_2 = sanSlash($_POST['rr_id_2']);
$rr_link_id_2 = sanSlash($_POST['rr_link_id_2']);
...
###########################################################################################
        ...
        $b->bindParam(":ri2",$rr_id_2);    $b->bindParam(":ril2",$rr_link_id_2);
