		...
		<?php foreach ($pe_data as $roomdate){  
                ...
                foreach ($prices as $price){ 
                    ...
                    if($price['price_adult']!='0'){ $displayPrice = 'price_adult'; };
                      ...
                      $price['total'] != '*' ? $displayInfo = "<div class='avail-data ".$class."'><span>".$price['total']."</span><span><b>".$price[$displayPrice].$extra."</b></span></div>" : $displayInfo = "<div class='avail-data ".$class."'><span><b>".$price[$displayPrice].$extra."</b></span></div>";
                      
                      $displayInfo = "<div class='avail-data ".$class."'><span><b>".$price[$displayPrice].$extra."</b></span></div>";
