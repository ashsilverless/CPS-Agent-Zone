			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="content-wrapper content-wrapper__single">
						<div class="header">
							<h2 class="heading heading__3"><?=$item['module_name'];?>
								<span><i class="fas fa-tags"></i></span>
							</h2>
						</div>
							<div class="card-item card-item__wide single-image">
								<div class="image image-overlay" style="background: url('../<?=$item['module_pic'];?>') no-repeat; background-size: 100%; background-color:#979185;">
					...
					<div class="content-wrapper content-wrapper__double">
						<div class="header">
							<h2 class="heading heading__3">Latest News
						...
						<div class="news-archive__item">
							...
							<div class="image image-overlay" style="background-image: url('../<?= $item['news_banner'];?>');">
								<h2 class="heading heading__4"><?= $item['news_title'];?></h2>
							</div>
							</a>
						</div>
						<?php }?>
				...
				<div class="col-md-7">
					<div class="content-wrapper content-wrapper__triple">
						<div class="header">
							<p class="heading">Shortcuts
								<span><i class="fas fa-share"></i></span>
							</p>
						</div>
						<?php foreach($single as $item){?>
						<a class="box-wrapper" href="<?=$item['module_link'];?>">
							<div class="image image__overlay  image-overlay" style="background:url('../<?=$item['module_pic'];?>') no-repeat; background-size: 100%; background-color:#979185;">
								<h2 class="heading heading__4"><?=$item['module_name'];?></h2>
