					...
					<div class="map-section bestfor">
						<div class="overlay">
                            ...
                            <div class="map-section__filter-detail">
                                ...
                                <div filter-data-facility="fac<?=$facilities[$f]['id'];?>" class="facbutton"><?=$facilities[$f]['facility_title'];?></div>&emsp;
                                <?php }?>
                            </div>
                        </div>
						<div class="bestformap">
                            <div id='bestformap' class="map-section__map" style='width: 100%; height: 35rem;'></div>
                        </div>
					</div>
				</div>
			</div>
